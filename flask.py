...
def upload_image():
    ...
    if file1 and allowed_file(file1.filename):
        ...
        #print(file_arr)
        #print(a, b)
        return render_template('webpage.html', filename1=filename1, filename2 = filename2)
...
def first():
    ...
    flash("Final Photo")
    return render_template("upload.html",filename1=file_arr[0], filename2 = file_arr[1])
